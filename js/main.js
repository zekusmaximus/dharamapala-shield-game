...
export class Game {
    ...
    update(deltaTime) {
        ...
        // Update defenses
        this.defenseManager.update(deltaTime);
    ...
    onMouseDown(e) {
        ...
        console.log(`[Main] MouseDown at raw: ${e.clientX},${e.clientY} -> game: ${this.mouse.x.toFixed(1)},${this.mouse.y.toFixed(1)}`);
    ...
    onTouchStart(e) {
        ...
        console.log(`[Main] TouchStart at raw: ${touch.clientX},${touch.clientY} -> game: ${this.touch.x.toFixed(1)},${this.touch.y.toFixed(1)}`);
    ...
    handleClick(x, y) {
        ...
        if (this.uiManager) {
            if (this.uiManager.handleClick(x, y)) {
                console.log('[Main] UI handled click');
        ...
        if (this.state === CONFIG.GAME_STATES.PLAYING) {
            console.log('[Main] Passing click to DefenseManager');
